  ...
  <div class="outer">
    <div class="container">
      <div class="left">
        ...
        <div class="err" v-show="errorAccount || errorPassword || errorRegister">
...
export default {
  ...
  methods: {
    checkAccount() {
      this.axios.get('/CheckAccount', { params: { account: this.account } }).then((data) => {
        this.errorAccount = data.data ? null : '帳號重複請重新輸入';
      });
    },
    checkForm() {
